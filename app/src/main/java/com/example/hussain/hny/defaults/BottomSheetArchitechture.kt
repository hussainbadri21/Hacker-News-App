...
class BottomSheetArchitecture : BottomSheetDialogFragment(), ArchitecturalTemplate {

    var TAG = "DefaultBottomSheet"
    ...
    //    public BottomSheetArchitecture(SharedPreferences shared_preferences, SharedPreferences.Editor shared_preferences_editor, Context mContext) {
    //        this.shared_preferences = shared_preferences;
    //        this.shared_preferences_editor = shared_preferences_editor;
